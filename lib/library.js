 ...
 */
var _parent = require('hyperloop-java').library,
...
exports.prepareClasses = _parent.prepareClasses;
...
function getArchitectures (options, callback) {
	var arch = options.arch ? options.arch : 'armeabi-v7a';
	return callback(null, [arch]);
}
